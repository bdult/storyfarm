...
<div id="divContent">
	...
	<div class="mypageRow">
		<dl>
			<dt>
				현재 이용중인 서비스 <a href="#"><img src="${ contextPath }/assets/images/common/btn_detailVew_off.gif" alt="자세히보기" class="btVew rollimg"></a>
			</dt>
			<dd>
	...
	<div class="mypageLst">
		<ul>
			<li class="mn01"><a href="#"><img src="${ contextPath }/assets/images/common/btn_mypage1_off.png" alt="쿠폰등록" class="rollimg"></a></li>
			<li class="mn02"><a href="#"><img src="${ contextPath }/assets/images/common/btn_mypage2_off.png" alt="회원정보수정" class="rollimg"></a></li>
			<li class="mn03"><a href="#"><img src="${ contextPath }/assets/images/common/btn_mypage3_off.png" alt="일시중지" class="rollimg"></a></li>
		</ul>
	</div>
