...
<div id="divContent">
	...
	<h2 class="divTit">
		<img src="${ contextPath }/assets/images/mypage/title_adjust.gif" alt="회원정보수정">
	</h2>
		...
		<table class="joinTbl">
			...
			<tbody>
				...
				<tr>
					...
					<td><input id="member_pw" name="member_pw" type="password" class="input" style="width: 205px;">
					<p class="mgt5">
							<strong class="fontRed">* 패스워드는 6-10자리 숫자 영문 조합입니다.</strong>
						</p></td>
				</tr>
				<tr class="brdB">
		...
		<table class="joinTbl mgt10">
			...
			<tbody>
				...
				<tr>
					<th scope="row">주소</th>
					<td colspan="3">
						<input type="text" class="input" style="width: 290px;" placeholder="동,읍,리 입력" readonly> 
						<a href="#"><img src="${ contextPath }/assets/images/common/btn_find_off.gif" alt="찾아보기" class="rollimg"></a>
						<div class="mgt5">
