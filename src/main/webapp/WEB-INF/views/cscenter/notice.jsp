...
<div class="row">
	<div class="col-md-3 pull-right">
		<form class="form-search" action="${ contextPath }/cscenter/notice.do" method="get">
		...
		<div class="text-center">
			<ul class="pagination">
				...
				<c:forEach items="${ pageLink.pageList }" var="page">
					...
					<a href="${ contextPath }/cscenter/notice.do?pageNum=${ page.pageNum }${ empty search.search? '' : search.search }&search=${ searchList.search }">${ page.pageNum }</a></li>
				</c:forEach>
