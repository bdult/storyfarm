            ...
            <div class="join01_hd"><img src="../assets/images/member/join01_img1.jpg" alt="오즈월드 회원 가입을 환영합니다! 전 세계 명작 학습 동화와 다양한 콘텐츠를 최적의 환경에서 제공하겠습니다."></div>
            	...
            	<ul class="ulLst01">
                	<li>회원 가입을 위해서 아래의 이용약관 및 개인정보 수집 및 이용에 대한 안내를 읽고 동의해 주세요.</li>
           	  	...
           	  	<h3 class="divTit mgt20"><img src="../assets/images/member/join01_tit1.gif" alt="이용약관"></h3>
            	<div class="divChk"> 
                	<input name="" type="checkbox" value="" id="checkall"> <label for="userChk">이용약관, 개인정보 수집 및 이용에 모두 동의 합니다.</label>
                </div>
              	<h4 class="divTit"><img src="../assets/images/member/join01_tx1.gif" alt="오즈월드 이용약관"></h4>
                ...
                <h4 class="divTit"><img src="../assets/images/member/join01_tx2.gif" alt="개인정보 수집 및 이용에 대한 안내"></h4>
                <div class="scrollBx" style="height:90px;">
                	본 이용문의와 관련하여 아래와 같이 개인정보가 수집·이용됨을 알려드립니다. 이용문의의 사실 관계 확인 및 처리 내용 안내를 위하여 반드시 필요한 정보이므로 개인정보 수집·이용에 동의하지 않으실 경우 이용문의를 이용하실 수가 없습니다.
                </div>
                <div class="divChk noBrd"> 
                ...
                <h3 class="divTit mgt20"><img src="../assets/images/member/join01_tit2.gif" alt="본인인증"></h3>
                <div class="box02">
                    ...
                    <div class="btnSc">
                    	<a href="#"><img src="../assets/images/member/btn_mobile_off.gif" alt="휴대폰 인증"  class="rollimg"></a>
                        <a href="#"><img src="../assets/images/member/btn_ipin2_off.gif" alt="아이핀 인증"  class="rollimg"></a>
                    </div>
                </div>
                ...
                <div class="btnSc aright">
                	<a href="#" id="submit_btn"><img src="../assets/images/common/btn_confirm2_off.gif" alt="확인" class="rollimg"></a>
                	<a href="#"><img src="../assets/images/common/btn_cancel_off.gif" alt="취소" class="rollimg"></a>
                </div>
            </div>
