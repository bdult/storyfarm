...
<div id="header">
	...
	<div id="gnbWrap">
		<h1 class="logo">
			<a href="${ contextPath }"><img src="${ contextPath}/assets/images/common/logo.png" alt="오즈월드"></a>
		</h1>
		<ul id="gnb">
			...
			<li><a href="${ contextPath }/worksheet.do"><img src="${ contextPath}/assets/images/common/gnb06.png" alt="프린트학습"></a></li>
		</ul>
	</div>
</div>
