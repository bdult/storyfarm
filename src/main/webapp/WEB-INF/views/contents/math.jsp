...
<div id="content">
	...
	<form id="playListForm" action="playList.do" method="post">
		<h2 class="divTit">
			<img src="${ contextPath }/assets/images/content/title_science.gif" alt="오즈월드 수학">
		</h2>
		<!-- location -->
		<div id="divLocation">
			<ul class="location">
				<li class="first"><a href="${ contextPath }" class="home"><img src="${ contextPath }/assets/images/common/blt_home.gif" alt="home"></a></li>
				<li class="current">수학</li>
			</ul>
		</div>
		<!-- //location -->

		<div class="topBanner">
			<img src="${ contextPath }/assets/images/content/science_Timg.jpg" alt="오즈월드 수학">
		</div>

		<!-- conLst -->
		<div class="conLst math">
			<ul>
					...
					<c:forEach items="${ pageLink.pageList }" var="page">
						<c:choose>
							<c:when test="${ page.pageNum eq pageLink.pageNum }">
								<strong class="math">${ page.pageNum }</strong>
							</c:when>
							<c:otherwise>
