...
<div id="content">
	...
	<form id="playListForm" action="playList.do" method="post">
		<h2 class="divTit">
			<img src="${ contextPath }/assets/images/content/title_english.gif" alt="오즈월드 영어">
		</h2>
		<!-- location -->
		<div id="divLocation">
			<ul class="location">
				<li class="first"><a href="${ contextPath }" class="home"><img src="${ contextPath }/assets/images/common/blt_home.gif" alt="home"></a></li>
				<li class="current">영어</li>
			</ul>
		</div>
		<!-- //location -->

		<div class="topBanner">
			<img src="${ contextPath }/assets/images/content/english_Timg.jpg" alt="오즈월드 영어">
		</div>

		<!-- conLst -->
		<div class="conLst english">
			<ul>
					...
					<c:forEach items="${ pageLink.pageList }" var="page">
						<c:choose>
							<c:when test="${ page.pageNum eq pageLink.pageNum }">
								<strong class="english">${ page.pageNum }</strong>
							</c:when>
							<c:otherwise>
