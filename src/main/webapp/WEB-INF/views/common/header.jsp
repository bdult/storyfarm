...
<div class="top">
    <div class="container">         
        <ul class="loginbar pull-right">
            ...
            <li class="devider">&nbsp;</li>
            <li><a href="loginpage.do" class="login-btn">Login</a></li>   
        </ul>
    </div>      
</div><!--/top-->
<!--=== End Top ===-->  
...
<div class="header">               
    <div class="container"> 
        <!-- Logo -->       
        <div class="logo">                                             
            <a href="index.html"><img id="logo-header" src="assets/img/logo/logo2.png" alt="Logo"></a>
        </div><!-- /logo -->        
        ...
        <div class="navbar">                                
            <div class="navbar-inner">                                  
                ...
                <div class="nav-collapse collapse">                                     
                    <ul class="nav top-2">
                        <li class="active">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">국어
                                <b class="caret"></b>                            
                            </a>
                        ...
                        <li>
                            <a href="" class="dropdown-toggle" data-toggle="dropdown">영어
                                <b class="caret"></b>                            
                            </a>
                            <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="" class="dropdown-toggle" data-toggle="dropdown">수학
                                <b class="caret"></b>                            
                            </a>
                            <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">과학
                                <b class="caret"></b>                            
                            </a>
                            <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">창의
                                <b class="caret"></b>                            
                            </a>
                            <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">동요
                                <b class="caret"></b>                            
                            </a>
                            <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">동화
                                <b class="caret"></b>                            
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="page_contact.html">Contact Default</a></li>
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">생활
                                <b class="caret"></b>                            
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="page_contact.html">Contact Default</a></li>
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">스토리팜소개
                                <b class="caret"></b>                            
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="page_contact.html">Contact Default</a></li>
                        ...
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">이벤트
                                <b class="caret"></b>                            
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="page_contact.html">Contact Default</a></li>
