...
public class StoryfarmConstants {
	...
	public final static int BREADCRUMB_CHILDREN_PLAYER = 601;
	
	public final static int BREADCRUMB_PARENTS_ROOM = 700;
	public final static int BREADCRUMB_PARENTS_STUDY = 701;
	public final static int BREADCRUMB_PARENTS_CHILDREN = 702;
	public final static int BREADCRUMB_PARENTS_TIME = 703;
	public final static int BREADCRUMB_PARENTS_ITEMS = 704;
	public final static int BREADCRUMB_PARENTS_SERIES = 705;
	public final static int BREADCRUMB_PARENTS_PERIOD = 706;
	public final static int BREADCRUMB_PARENTS_WEEKLY = 707;
	public final static int BREADCRUMB_PARENTS_MONTHLY = 708;
